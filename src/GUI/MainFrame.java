...
public class MainFrame extends JFrame{
	...
	private void init(){
		...
		debugItem=new JMenuItem("调试");
		debugItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F6,0));
		continueItem=new JMenuItem("继续");
		continueItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F7,0));
